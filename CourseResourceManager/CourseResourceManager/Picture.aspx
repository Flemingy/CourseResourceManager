<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Picture.aspx.cs" Inherits="CourseResourceManager.Picture" %>
...
<body>
    <form id="form1" runat="server">
        <div style="height: 40px; padding: 15px; background-color: lightblue">
            <div id="back">
                <a href="./Home.aspx">
                    <asp:Label runat="server" ID="backLabel" Text="返回管理面板" Font-Bold="true"></asp:Label>
                </a>
            </div>
            <div id="welc">
                <asp:Label runat="server" ID="timeLabel" Text="欢迎来看我拍摄的照片~" Font-Bold="true"></asp:Label>
            ...
            <div style="text-align: center; float: left; margin-left: 128px; margin-top: 15px; width: 285px;">
                <span>上传照片数量:</span>
