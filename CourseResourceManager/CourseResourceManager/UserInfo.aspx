<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserInfo.aspx.cs" Inherits="CourseResourceManager.UserInfo" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div style="margin: 20px;">
            <span><a href="Picture.aspx">返回展示面板</a></span>
            <asp:LinkButton ID="LkBackToUserHome" runat="server" Text="*" OnClick="LkBackToUserHome_Click">LinkButton</asp:LinkButton>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <!--图片上传-->
        <div id="ToUploadImg" style="float: left; width: 24%; margin: 5px; padding-left: 80px; padding-top: 40px;">
        ...
        <div id="Preview" style="float: left; margin-left: 100px; padding: 100px">
            <asp:Image runat="server" ID="Image1" Style="z-index: 35; left: 0px; top: 0px" Width="360px" />
        </div>
